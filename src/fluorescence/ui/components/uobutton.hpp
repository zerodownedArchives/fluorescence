...
public:
    ...
    void setTexture(unsigned int index, boost::shared_ptr<ui::Texture> texture, unsigned int hue, const std::string& rgba, float alpha, bool tiled);
...
private:
    ...
    boost::shared_ptr<ui::Texture> allTextures_[3];
    CL_Colorf allColors_[3];
    CL_Vec3f allHueInfos_[3];
    bool allTiled_[3];
