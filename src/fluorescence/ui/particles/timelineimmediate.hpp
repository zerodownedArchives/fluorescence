...
#ifndef FLUO_UI_PARTICLES_TIMELINEIMMEDIATE_HPP
#define FLUO_UI_PARTICLES_TIMELINEIMMEDIATE_HPP
...
class TimelineImmediate : public TimelineElement {
public:
    TimelineImmediate(const ParticleEmitterState& state, unsigned int count);
