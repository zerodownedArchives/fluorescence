...
#ifndef FLUO_UI_PARTICLES_TIMELINEPAUSE_HPP
#define FLUO_UI_PARTICLES_TIMELINEPAUSE_HPP
...
class TimelinePause : public TimelineElement {
public:
    TimelinePause(float duration);
