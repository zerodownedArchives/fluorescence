...
#ifndef FLUO_UI_PARTICLES_TIMELINEEVENT_HPP
#define FLUO_UI_PARTICLES_TIMELINEEVENT_HPP
...
class TimelineEvent : public TimelineElement {
public:
    TimelineEvent(const UnicodeString& event);
    ...
    bool consumesEvent(const UnicodeString& event) const;
    
private:
    UnicodeString event_;
};
