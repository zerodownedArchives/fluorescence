...
#ifndef FLUO_UI_PARTICLES_TIMELINEBLEND_HPP
#define FLUO_UI_PARTICLES_TIMELINEBLEND_HPP
...
class TimelineBlend : public TimelineElement {
public:
    TimelineBlend(const ParticleEmitterState& state1, const ParticleEmitterState& state2, float duration);
