...
#ifndef FLUO_UI_PARTICLES_TIMELINEINTERPOLATE_HPP
#define FLUO_UI_PARTICLES_TIMELINEINTERPOLATE_HPP
...
class TimelineInterpolate : public TimelineElement {
public:
    TimelineInterpolate(const ParticleEmitterState& state1, const ParticleEmitterState& state2, float duration);
...
private:
    ParticleEmitterState state1_;
    ParticleEmitterState state2_;
