...
#define LOG_DEBUG \
if (fluo::updater::LOG_LEVEL_DEBUG < fluo::updater::Log::getSingleton()->getReportingLevel()) ; \
else fluo::updater::Log::getSingleton()->prefix(fluo::updater::LOG_LEVEL_DEBUG)

#define LOG_INFO \
if (fluo::updater::LOG_LEVEL_INFO < fluo::updater::Log::getSingleton()->getReportingLevel()) ; \
else fluo::updater::Log::getSingleton()->prefix(fluo::updater::LOG_LEVEL_INFO)

#define LOG_WARN \
if (fluo::updater::LOG_LEVEL_WARN < fluo::updater::Log::getSingleton()->getReportingLevel()) ; \
else fluo::updater::Log::getSingleton()->prefix(fluo::updater::LOG_LEVEL_WARN)

#define LOG_ERROR \
if (fluo::updater::LOG_LEVEL_ERROR < fluo::updater::Log::getSingleton()->getReportingLevel()) ; \
else fluo::updater::Log::getSingleton()->prefix(fluo::updater::LOG_LEVEL_ERROR)

#define LOG_EMERGENCY \
if (fluo::updater::LOG_LEVEL_EMERGENCY < fluo::updater::Log::getSingleton()->getReportingLevel()) ; \
else fluo::updater::Log::getSingleton()->prefix(fluo::updater::LOG_LEVEL_EMERGENCY)


#define LOG_INIT(level) fluo::updater::Log::getSingleton()->setLevel(level)
#define LOG_CLOSE fluo::updater::Log::getSingleton()->close()
